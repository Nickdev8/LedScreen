...
The sd card reads for a file named [firmware.uf2](example_firmware.uf2). You can build this file from the adruino ide or find the latest in the [Repo's Releases page](https://github.com/Nickdev8/LedScreen/releases)
